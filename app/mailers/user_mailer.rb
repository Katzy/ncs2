class UserMailer < ActionMailer::Base
  ...
  def new_user(user)
    @user = user
    mail(to: @user.email, subject: "NCS WRESTLING CHAMPIONSHIP 2016 / LOGIN DETAILS")
  end
  ...
  def team_upload(wrestler_array)
    ...
    mail(to: ["scottalankatz@gmail.com", "lhkatz@pacbell.net"], subject: "#{@user.school} Imported Roster")
  end
